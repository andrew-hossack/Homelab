...
class PiHoleSensor(PiHoleEntity, SensorEntity):
    ...
    def native_value(self) -> StateType:
        ...
        try:
            return round(getattr(self.api, self.entity_description.key), 2)  # type: ignore[no-any-return]
        except TypeError:
            return getattr(self.api, self.entity_description.key)  # type: ignore[no-any-return]
